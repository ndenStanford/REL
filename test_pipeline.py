...
entities = {
    "entities": [
        ...
        {
            "entity_tokens": ["Dan", "I", "##ves"],
            "entity_type": "per",
            "entity_text": "Dan Ives",
            "sentence_indexes": [0],
        },
        {
            "entity_tokens": ["We", "##dbu", "##sh"],
            "entity_type": "org",
            "entity_text": "Wedbush",
            "sentence_indexes": [0],
        },
        {
            ...
            "entity_type": "geo",
            "entity_text": "China",
            "sentence_indexes": [1, 7],
        },
        {
            "entity_tokens": ["Berlin"],
            "entity_type": "geo",
            "entity_text": "Berlin",
            "sentence_indexes": [2],
        },
        {
            "entity_tokens": ["Austin"],
            "entity_type": "geo",
            "entity_text": "Austin",
            "sentence_indexes": [2],
        },
        {
            "entity_tokens": ["Tesla", "##s"],
            "entity_type": "per",
            "entity_text": "Teslas",
            "sentence_indexes": [0, 2, 6, 7, 10],
        },
        {
            "entity_tokens": ["1800"],
            "entity_type": "tim",
        ...
        },
        {
            ...
            "entity_type": "per",
            "entity_text": "Ives",
            "sentence_indexes": [0, 3, 4, 6, 7],
        },
        {
            "entity_tokens": ["Yahoo", "Finance", "Live"],
            "entity_type": "org",
            "entity_text": "Yahoo Finance Live",
            "sentence_indexes": [3],
        },
        {
            "entity_tokens": ["Tesla"],
            "entity_type": "per",
            "entity_text": "Tesla",
            "sentence_indexes": [0, 2, 4, 5, 6, 7, 9, 10, 11],
        },
        {
            "entity_tokens": ["Out", "##per", "##form"],
            "entity_type": "org",
            "entity_text": "Outperform",
            "sentence_indexes": [4],
        },
        {
            "entity_tokens": ["EV"],
        ...
        {
            "entity_tokens": ["Street"],
            "entity_type": "tim",
            "entity_text": "Street",
            "sentence_indexes": [4, 9],
        },
        {
            "entity_tokens": ["Tesla", "##s"],
            "entity_type": "per",
        ...
        {
            "entity_tokens": ["December"],
            "entity_type": "tim",
            "entity_text": "December",
            "sentence_indexes": [11],
        },
        {
            "entity_tokens": ["Elo", "##n", "Mus", "##k"],
            "entity_type": "per",
...
results = process_results(mentions_dataset, predictions, sample, include_offset=False)
